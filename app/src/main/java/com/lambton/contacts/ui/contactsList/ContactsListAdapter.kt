...
import com.lambton.contacts.databinding.ListItemContactsBinding
import kotlinx.android.synthetic.main.list_item_contacts.view.*

class ContactsAdapter(val context: Context, val contactsClickListener: ContactsClickListener) :
    ListAdapter<Contact, RecyclerView.ViewHolder>
